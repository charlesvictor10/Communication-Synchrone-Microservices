# Communication-Synchrone-Microservices

__Description du projet__

__*Communication synchrone microservice*__ est un projet pour comprendre la communication synchrone entre les micro services avec l'utilisation d'Open feign. Dans ce projet nous avons utilisé les normes de codages telles que les dtos, Lombok, bien structuré notre projet.
